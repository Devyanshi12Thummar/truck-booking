...
$mobile=$row['user_contactno_primary'];
    ...
    $sql1 = "CREATE TRIGGER book_confirm AFTER DELETE ON truck_booking FOR EACH ROW BEGIN INSERT INTO confirm_booking VALUES ( old.booking_id, old.booking_date, old.pickup_date, old.drop_date, old.pickup_address, old.drop_address, old.goods_weight, old.user_id, old.truck_id, old.goods_id, old.pikup_time, old.drop_time ); END;";
    if (mysqli_query($conn, $sql1))
     {
        $sql2 = "DELETE from truck_booking where booking_id=$id";
        if (mysqli_query($conn, $sql2)) {
            $sql3 = "DROP TRIGGER book_confirm";
    ...
    $mess="Your Truck Booking has been Accepted!";
    sendSMS($mobile,$mess) ;
