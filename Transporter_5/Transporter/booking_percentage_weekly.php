...
$sqlcity="SELECT COUNT(*) as count ,pickup_address from truck_booking WHERE YEAR(booking_date)=MONTHNAME(NOW()) and WEEK(booking_date)=WEEK(NOW()) GROUP BY pickup_address; ";
